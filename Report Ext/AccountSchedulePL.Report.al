report 50223 "Account Schedule PL"
{
    // Text004
    DefaultLayout = RDLC;
    ...
    dataset
    {
        dataitem("AccSchedule Name"; "Acc. Schedule Name")
        {
            ...
            dataitem(Heading; "Integer")
            {
                ...
                column(AccScheduleName_Description_Text004_PeriodText; AccScheduleName.Description + Text004 + PeriodText)
                {
                }
                ...
                column(AccScheduleName_Name_Control68; "Acc. Schedule Line"."Schedule Name")
                {
                }
