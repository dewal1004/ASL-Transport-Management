report 91192 "Vessel Performances Grpg2xxx"
{
    // XVal[1]::Nairaval
    // XVal[2]::ExpVal
    // XVal[3]::NairaVal
    // XVal[4]::AGVal
    DefaultLayout = RDLC;
    RDLCLayout = './VesselPerformancesGrpg2xxx.rdlc';
        ...
        dataitem(Job; Job)
        {
            ...
            dataitem("Job catch Default"; "Job catch Default")
            {
                ...
                begin
                    ...
                    /* IF Itempr."Currency Code"<>''// & u THEN
                    BEGIN
                      PrdPrcB:=QtyB*PrcB;
            ...
            dataitem("Integer"; "Integer")
            {
                ...
                begin
                    ...
                    //Job.SETFILTER(Job."Task Filter",JobSetup."Export Prouct Code"); // & u
                    ...
                    if JBudLn.Find('-') then begin
                        // JBudLn.CALCFIELDS(JBudLn.Counter); // & u
                        // PeopleOnVoy:=JBudLn.Counter;// & u
                    end
                    else
    ...
    begin
        ...
        // Itempr.SETRANGE(Itempr."Starting Date",0D,PDays); //& u
        // Itempr.SETRANGE(Itempr."Price Group Code",job3."Price Group Code");//&u
        if Itempr.Find('+') then
            Prc := Itempr1."Unit Price" else begin
            // Itempr.SETRANGE(Itempr."Price Group Code",JobSetup."Default Price Group Code"); // & u
            if Itempr.Find('+') then
                Prc := Itempr1."Unit Price" else begin
                Prc := 0;
