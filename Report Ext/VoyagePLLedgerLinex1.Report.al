report 61151 "Voyage P&L Ledger Line x1"
{
    DefaultLayout = RDLC;
    RDLCLayout = './VoyagePLLedgerLinex1.rdlc';
    ...
    dataset
    {
        dataitem("Job Ledger Entry"; "Job Ledger Entry")
        {
            ...
            column(Job_Ledger_Entry_Entry_No_; JBudLn."Entry No.")
            {
            ...
            begin
                ...
                if (CurrReport.TotalsCausedBy = "Job Ledger Entry".FieldNo("Job No.")) then begin
                    ...
                    CycleDay := Job."Sea Days" + Job."Lost Days" + PortDay;
                    ...
                    repeat
                        ...
                        ResCount := ResCount + 1;
                    until JBudLn.Next() = 0;
                    DataStor[5] := JobSetUp."Travelling Expenses Rate" * expcnt;
                    ...
                    DataStor[8] := JobSetUp.Clearing_Fwrd_NPA * 10000;
                    DataStor[12] := JobSetUp."Shore Overheads" * CycleDay;

                    CurrExc.SetRange(CurrExc."Currency Code", 'USD');
                    CurrExc.SetRange(CurrExc."Starting Date", 0D, Job."Ending Date");
        ...
        dataitem("Sea Food categories"; "Sea Food categories")
        {
            ...
            dataitem("Job Ledger Entry Rep"; "Job Ledger Entry")
            {
                ...
                column(Job_Ledger_Entry_Rep_Entry_No_; JBudLn."Entry No.")
                {
                }
