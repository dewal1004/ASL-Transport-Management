report 58151 "Voyage P&L Ledger LineXX"
{
    DefaultLayout = RDLC;
    RDLCLayout = './VoyagePLLedgerLineXX.rdlc';

    dataset
    {
        dataitem("Job Ledger Entry"; "Job Ledger Entry")
        {
            DataItemTableView = SORTING ("Job No.", "Location Code", "Work Type Code") WHERE ("Location Code" = CONST ('CRM-ASL'), "Job No." = CONST ('J03232'));
