...
{
    DefaultLayout = RDLC;
    RDLCLayout = './DailyBreakUpByVesselz.rdlc';
    ...
    dataset
    {
        dataitem(Item; Item)
        {
            ...
            column(Item__Inventory_Posting_Group__Control1000000077; "Inventory Posting Group")
            {
            }
            column(Item_Description_Control1000000078; Description)
            {
            }
            column(Item_Inventory_Control1000000079; Inventory)
            {
                DecimalPlaces = 2 : 5;
            }
            ...
            column(SeaRangeC_4__Control1000000014; SeaRangeC[4])
            {
            }
            column(SeaRangeC_3__Control1000000016; SeaRangeC[3])
            {
            }
            column(SeaRangeC_2__Control1000000017; SeaRangeC[2])
            {
            }
            column(SeaRangeC_1__Control1000000018; SeaRangeC[1])
            {
            }
            column(SeaRangeC_8__Control1000000022; SeaRangeC[8])
            {
            }
            column(SeaRangeC_7__Control1000000023; SeaRangeC[7])
            {
            }
            column(SeaRangeC_6__Control1000000024; SeaRangeC[6])
            {
            }
            column(SeaRangeC_5__Control1000000025; SeaRangeC[5])
            {
            }
            column(SeaRangeC_24__Control1000000047; SeaRangeC[24])
            {
            }
            column(SeaRangeC_23__Control1000000048; SeaRangeC[23])
            {
            }
            column(SeaRangeC_22__Control1000000049; SeaRangeC[22])
            {
            }
            column(SeaRangeC_21__Control1000000050; SeaRangeC[21])
            {
            }
            column(SeaRangeC_20__Control1000000051; SeaRangeC[20])
            {
            }
            column(SeaRangeC_19__Control1000000052; SeaRangeC[19])
            {
            }
            column(SeaRangeC_18__Control1000000053; SeaRangeC[18])
            {
            }
            column(SeaRangeC_17__Control1000000054; SeaRangeC[17])
            {
            }
            column(SeaRangeC_16__Control1000000055; SeaRangeC[16])
            {
            }
            column(SeaRangeC_15__Control1000000056; SeaRangeC[15])
            {
            }
            column(SeaRangeC_14__Control1000000057; SeaRangeC[14])
            {
            }
            column(SeaRangeC_13__Control1000000058; SeaRangeC[13])
            {
            }
            column(SeaRangeC_12__Control1000000059; SeaRangeC[12])
            {
            }
            column(SeaRangeC_11__Control1000000060; SeaRangeC[11])
            {
            }
            column(SeaRangeC_10__Control1000000061; SeaRangeC[10])
            {
            }
            column(SeaRangeC_9__Control1000000062; SeaRangeC[9])
            {
            }
