report 50093 "Sales Delivery Note"
{
    //  SalesLine.Numbers
    //  "Shipment Text"
    DefaultLayout = RDLC;
    RDLCLayout = './SalesDeliveryNote.rdlc';
            ...
            dataitem(CopyLoop; "Integer")
            {
                ...
                dataitem(PageLoop; "Integer")
                {
                    ...
                    dataitem(RoundLoop; "Integer")
                    {
                        ...
                        column(UOM; SalesLine."Unit of Measure")
                        {
                        }
    ...
    var
        ...
        Text004: Label 'Delivery Note No.  - %1';
        ...
        SalesCountPrinted: Codeunit "DN-Printed";
