report 55191 "Vessel Performance Consolidatx"
{
    // "Period Start":=010103D;
    // "Period End":= 010503D;
    // "Period Start":=CALCDATE('CM-2M+1D',030503D);
    // "Period End":=CALCDATE('CM-1M',030503D);//020503D;//
    DefaultLayout = RDLC;
    RDLCLayout = './VesselPerformanceConsolidatx.rdlc';
    ...
    dataset
    {
        ...
        dataitem(Jb; Job)
        {
            ...
            dataitem(JbLedMark; "Job Ledger Entry")
            {
                ...
                column(JbLedMark__Entry_No__; JbLedMark."Entry No.")
                {
                }
                ...
                column(JbLedMark__Entry_No__Caption; JbLedMark."Entry No.")
                {
                }
        ...
        dataitem("Sea Food categories"; "Sea Food categories")
        {
            ...
            dataitem("Job Ledger Entry"; "Job Ledger Entry")
            {
                ...
                column(Job_Ledger_Entry_Entry_No_; JbLedMark."Entry No.")
                {
                }
        ...
        dataitem("Sea Food categories1"; "Sea Food categories")
        {
            ...
            column(SeaRangeCVar_4__Control1000000584; SeaRangeCVar[4])
            {
                DecimalPlaces = 0 : 0;
            }
            column(SeaRangeC_4__Control1000000585; SeaRangeC[4])
            {
                DecimalPlaces = 0 : 0;
            }
            column(SeaRangeCBud_4__Control1000000586; SeaRangeCBud[4])
            {
                DecimalPlaces = 0 : 0;
            }
            column(SeaRangeCVar_3__Control1000000587; SeaRangeCVar[3])
            {
                DecimalPlaces = 0 : 0;
            }
            column(SeaRangeC_3__Control1000000588; SeaRangeC[3])
            {
                DecimalPlaces = 0 : 0;
            }
            column(SeaRangeCBud_3__Control1000000589; SeaRangeCBud[3])
            {
                DecimalPlaces = 0 : 0;
            }
            column(SeaRangeCVar_2__Control1000000590; SeaRangeCVar[2])
            {
                DecimalPlaces = 0 : 0;
            }
            column(SeaRangeC_2__Control1000000591; SeaRangeC[2])
            {
                DecimalPlaces = 0 : 0;
            }
            column(SeaRangeCBud_2__Control1000000592; SeaRangeCBud[2])
            {
                DecimalPlaces = 0 : 0;
            }
            ...
            dataitem("Job Ledger Entry1"; "Job Ledger Entry")
            {
                ...
                column(Job_Ledger_Entry1_Entry_No_; "Job Ledger Entry"."Entry No.")
                {
                }
        ...
        dataitem("Sea Food categories2"; "Sea Food categories")
        {
            ...
            dataitem("Job Ledger Entry2"; "Job Ledger Entry")
            {
                ...
                column(Job_Ledger_Entry2_Entry_No_; "Job Ledger Entry"."Entry No.")
                {
                }
                ...
                begin
                    ...
                    level:=TotLoc+1;
                    REPEAT
                      IF SeaRange[level]="Job Ledger Entry2"."Source Code" THEN
                      BEGIN
                        StoreC[level]:=Qty;
