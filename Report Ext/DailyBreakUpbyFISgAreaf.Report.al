report 51044 "Daily BreakUp by FISg Areaf"
{
    // T001
    DefaultLayout = RDLC;
    RDLCLayout = './DailyBreakUpbyFISgAreaf.rdlc';
    ...
    dataset
    {
        ...
        {
            DataItemTableView = SORTING ("Statistics Group", Category) ORDER(Ascending) WHERE ("Statistics Group" = FILTER (<> 0), "In Use" = CONST (true));
