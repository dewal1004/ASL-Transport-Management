report 50015 "Vessel Daily Log"
{
    // "Operation Daily Radio".GETFILTERS
    // Jobs."Voyage No."
    DefaultLayout = RDLC;
    RDLCLayout = './VesselDailyLog.rdlc';
    ...
    dataset
    {
        dataitem("Operation Daily Radio"; "Operation Daily Radio")
        {
            ...
            column(DisplayOptions; DisplayOptions)
            {
            }
            ...
            column(CatchCaption; CatchCaptionLbl)
            {
            }
            ...
            column(Jobs_Captain; Jobs.Captain)
            {
            }
