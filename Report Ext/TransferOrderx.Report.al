report 95703 "Transfer Orderx"
{
    ...
    // "Transfer Line".ROB
    DefaultLayout = RDLC;
    RDLCLayout = './TransferOrderx.rdlc';
            ...
            dataitem(CopyLoop; "Integer")
            {
                ...
                dataitem(PageLoop; "Integer")
                {
                    ...
                    dataitem("Transfer Line"; "Transfer Line")
                    {
                        ...
                        column(ROBCaption; ROBCaptionLbl)
                        {
                        }
                        ...
                        column(ROBCaption_Control1000000046; ROBCaption_Control1000000046Lbl)
                        {
                        }
                        ...
                        begin
                            ...
                            //DocDim2.SETRANGE("Document Type",5); #1
                            //DocDim2.SETRANGE("Document No.","Transfer Line"."Document No.");
    ...
    var
        ...
        ROBCaption_Control1000000046Lbl: Label 'ROB';
