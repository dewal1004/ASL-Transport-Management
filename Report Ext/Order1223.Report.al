report 59405 Order1223
{
    DefaultLayout = RDLC;
    RDLCLayout = './Order1223.rdlc';
    Caption = 'Order';
    ...
    dataset
    {
        dataitem("Purchase Header"; "Purchase Header")
        {
            ...
            column(PurchaseHeaderVendorShipmentNo; "Purchase Header"."Vendor Shipment No.")
            {
            }
            column(PaymentTermsDescription; PaymentTerms.Description)
            {
            }
            column(PurchaseHeaderValidity; "Purchase Header".Validity)
            {
            }
            column(PurchLineInvDiscAmtCaption; PurchLineInvDiscAmtCaptionLbl)
            {
            }
            column(Purchaser; SalesPurchPerson.Name)
            {
            }
            ...
            column(ValidityCaptionLbl; ValidityCaptionLbl)
            {
            }
            ...
            column(YourReferencCaption; YourReferencCaptionLbl)
            {
            }
            ...
            dataitem(CopyLoop; "Integer")
            {
                ...
                dataitem(PageLoop; "Integer")
                {
                    ...
                    dataitem("Purchase Line"; "Purchase Line")
                    {
                        ...
                        DataItemLinkReference = "Purchase Header";
                        DataItemTableView = SORTING ("Document Type", "Document No.", "Line No.") WHERE (Type = FILTER (<> "G/L Account"));
                    ...
                    dataitem(Total2; "Integer")
                    {
                        ...
                        column(PayToVendName_PurchHeader; "Purchase Header"."Pay-to Name")
                        {
                        }
