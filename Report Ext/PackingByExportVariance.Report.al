report 50181 "Packing By Export Variance"
{
    ...
    dataset
    {
        dataitem(Location; Location)
        {
            ...
            dataitem(Item; Item)
            {
                DataItemTableView = SORTING ("Product Group Code") WHERE ("Item Category Code" = FILTER ('PK'), "Inventory Entry Type Filter" = CONST (Transfer));
                ...
                begin
                    ...
                    case Item."Product Group Code" of
                        'LOC':
