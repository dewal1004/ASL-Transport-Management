report 50021 "ALL Fish Shop Sales Report"
{
    //   "Sea Food categories"
    DefaultLayout = RDLC;
    RDLCLayout = './ALLFishShopSalesReport.rdlc';
    ...
    dataset
    {
        dataitem("Sea Food categories"; "Sea Food categories")
        {
            ...
            dataitem(Item; Item)
            {
                ...
                DataItemTableView = SORTING ("SF Cat", "No. 2") WHERE ("Gen. Prod. Posting Group" = FILTER ('FIS'), "Sales (Qty.)" = FILTER (<> 0));
