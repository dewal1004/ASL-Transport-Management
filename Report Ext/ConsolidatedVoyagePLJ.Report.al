report 98150 "Consolidated Voyage P&LJ"
{
    DefaultLayout = RDLC;
    RDLCLayout = './ConsolidatedVoyagePLJ.rdlc';
    ...
    dataset
    {
        dataitem(Job; Job)
        {
            ...
            column(JB__Starting_Date_; "Starting Date")
            {
            }
            column(JB__Ending_Date_; "Ending Date")
            {
            }
            column(JB_Description; Description)
            {
            }
            column(JB_Vessel; Vessel)
            {
            }
            column(JB_DescriptionCaption; FieldCaption(Description))
            {
            }
            column(JB__Ending_Date_Caption; FieldCaption("Ending Date"))
            {
            }
            column(JB__Starting_Date_Caption; FieldCaption("Starting Date"))
            {
            }
            column(JB_VesselCaption; FieldCaption(Vessel))
            {
            }
