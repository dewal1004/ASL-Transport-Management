...
{
    DefaultLayout = RDLC;
    RDLCLayout = './TESTGROUP.rdlc';

    dataset
    {
        dataitem("Job Ledger Entry"; "Job Ledger Entry")
        {
            DataItemTableView = SORTING ("Location Code", GroupSort) WHERE ("Location Code" = CONST ('CRM-ASL'), "Source Code" = CONST ('ADNA'));
            RequestFilterFields = "Job No.", "Location Code", GroupSort, "Posting Date";
            ...
            column(JobNo; "Job Ledger Entry"."Job No.")
            {
            }
