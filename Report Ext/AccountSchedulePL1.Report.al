report 50165 "Account Schedule PL1"
{
    // Text004
    DefaultLayout = RDLC;
    RDLCLayout = './AccountSchedulePL1.rdlc';
    ...
    dataset
    {
        dataitem(AccScheduleName; "Acc. Schedule Name")
        {
            ...
            dataitem(Heading; "Integer")
            {
                ...
                dataitem("Acc. Schedule Line"; "Acc. Schedule Line")
                {
                    ...
                    begin
                        ...
                        SetRange("Date Filter", CalcDate('CM-2M+1D'), CalcDate('CM-1M'));
                    end;
                }
            }
            ...
            trigger OnPreDataItem()
            begin
                if GLSetup.Get then SetFilter(Name, GLSetup."Schedule Name 1");
            end;
        }
    }
                ...
                repeat
                    if ColLayoutTmp.Show <> ColLayoutTmp.Show::Never then begin
                        ...
                        if AccSchedManagement.GetDivisionError then begin
                            ...
                            ColumnValuesAsText[i] :=
                              AccSchedManagement.FormatCellAsText(ColLayoutTmp, ColumnValuesDisplayed[i], false);
                        end;
                    end;
                until (i >= MaxColumnsDisplayed) or (Next = 0);
        end;
