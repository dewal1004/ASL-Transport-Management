report 75150 "Consolidated Voyage P&L xc"
{
    DefaultLayout = RDLC;
    RDLCLayout = './ConsolidatedVoyagePLxc.rdlc';
    ...
    dataset
    {
        ...
        dataitem("Sea Food categories"; "Sea Food categories")
        {
            ...
            dataitem("Job catch Default"; "Job catch Default")
            {
                ...
                column(QtyB_Control1000000117; Qty)
                {
                }
        ...
        dataitem("Integer"; "Integer")
        {
            ...
            trigger OnAfterGetRecord()
            begin
                TotDirExp := TotPrice + DataStor[3] + DataStor[4] + DataStor[5] + DataStor[6] + DataStor[7] + DataStor[8];   //  #1
            end;
