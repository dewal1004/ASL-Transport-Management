report 59998 "Daily BreakUp by Vess Summary1"
{
    ...
    DefaultLayout = RDLC;
    RDLCLayout = './DailyBreakUpbyVessSummary1.rdlc';
    ...
    dataset
    {
        dataitem("Inventory Posting G Cat Tot"; "Inventory Posting Group")
        {
            ...
            column(TotLoc_PntLess; TotLoc - PntLess)
            {
                DecimalPlaces = 0 : 0;
            }
            ...
            column(TotalVessel; TotalVessel)
            {
            }
            column(Table1; 1)
            {
            ...
            begin
                ...
                if locate.FindFirst then
                    repeat
                        ...
                        if VesselPoint[Countx] = 0 then PntLess := PntLess + 1;
        ...
        {
            DataItemTableView = WHERE (Code = CONST ('XXXXXX'));
