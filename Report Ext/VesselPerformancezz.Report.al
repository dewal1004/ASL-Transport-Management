report 58190 "Vessel Performance zz"
{
    DefaultLayout = RDLC;
    RDLCLayout = './VesselPerformancezz.rdlc';
    ...
    dataset
    {
        dataitem(Job; Job)
        {
            ...
            column(Job__No___Control1000000074; "No.")
            {
            }
            ...
            column(Job__No___Control1000000074Caption; FieldCaption("No."))
            {
            }
