report 50085 "Vessel Catches"
{
        ...
        dataitem("Job Journal Batch"; "Job Journal Batch")
        {
            ...
            dataitem("Integer"; "Integer")
            {
                ...
                dataitem("Job Journal Line"; "Job Journal Line")
                {
                    ...
                    column(DataItem1000000028; KNOWING_THAT_WE_CAN_BE_HELD_LIABLE_FOR_FALSIFYING_INFORMATION__WE_CERTIFY_THIS_REPORT_TO_BE_TRUE_AND_ACCURATE_TO_THE_BEST_OF_Lbl)
                    {
                    }
    ...
    begin
        g_Template := "Job Journal Line".GetFilter("Journal Template Name");
        g_Batch := "Job Journal Line".GetFilter("Journal Batch Name");
    end;
    ...
    var
        ...
        KNOWING_THAT_WE_CAN_BE_HELD_LIABLE_FOR_FALSIFYING_INFORMATION__WE_CERTIFY_THIS_REPORT_TO_BE_TRUE_AND_ACCURATE_TO_THE_BEST_OF_Lbl: Label 'KNOWING THAT WE CAN BE HELD LIABLE FOR FALSIFYING INFORMATION, WE CERTIFY THIS REPORT TO BE TRUE AND ACCURATE TO THE BEST OF OUR KNOWLEDGE';
