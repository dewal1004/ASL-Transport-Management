        ...
        dataitem("Gen. Journal Batch"; "Gen. Journal Batch")
        {
            ...
            dataitem("Integer"; "Integer")
            {
                ...
                dataitem("Gen. Journal Line"; "Gen. Journal Line")
                {
                    ...
                    column(ExtrernalDocNo; "External Document No.")
                    {
                    }
                    ...
                    column(Description1_GenJournalLine; "Gen. Journal Line".Description1)
                    {
                    }
                    ...
                    column(DiamensionCode; "Shortcut Dimension 1 Code")
                    {
                    }
                    ...
                    begin
                        ...
                        BEGIN
                         ...
                         //MESSAGE('I got it %1',BankAcc."Bank Acc. Posting Group");
                         IF BankAccPostingGroup.GET(BankAcc."Bank Acc. Posting Group")  THEN "Account No.":=BankAccPostingGroup."G/L Bank Account No.";
                        END;
                        IF "Bal. Account Type"=3 THEN
                        BEGIN
            ...
            begin
                ...
                if "Gen. Journal Batch"."Reason Code" = 'PAYMENT' then
                    ReportCaption := Text074
                else
                    if "Gen. Journal Batch"."Reason Code" = 'RECEIPT' then
                        ReportCaption := Text075
                    else
                        if "Gen. Journal Batch"."Reason Code" = 'JOURNAL' then
                            ReportCaption := Text076
                        else
                            ReportCaption := '';
                //UNL-ASL3.60.01.009 (Santus) June 14, 2005
            end;
