report 50998 "Voyage P&L Ledger LineXA"
{
    DefaultLayout = RDLC;
    RDLCLayout = './VoyagePLLedgerLineXA.rdlc';
    ...
    dataset
    {
        dataitem("Job Ledger Entry"; "Job Ledger Entry")
        {
            ...
            column(Job_Ledger_Entry_Entry_No_; "Phase Code")
            {
            }
            ...
            begin
                ...
                if (CurrReport.TotalsCausedBy = "Job Ledger Entry".FieldNo("Job No.")) then begin
                    ...
                    if CountryRegion.Get(Job."Bill-to Country/Region Code") then
        ...
        dataitem("Sea Food categories"; "Sea Food categories")
        {
            ...
            dataitem("Job Ledger Entry Rep"; "Job Ledger Entry")
            {
                ...
                column(Job_Ledger_Entry_Rep_Entry_No_; "Phase Code")
                {
                }
