report 50234 "Institutional Sales Report"
{
    //   "Sea Food categories"
    DefaultLayout = RDLC;
    ...
    dataset
    {
        dataitem("Sea Food categories"; "Sea Food categories")
        {
            ...
            column(Institution_Sales_ReportCaption; Institution_Sales_ReportCaptionLbl)
            {
            }
    ...
    var
        ...
        Institution_Sales_ReportCaptionLbl: Label 'Institution Sales Report';
