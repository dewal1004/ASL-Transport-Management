report 59088 "Consolidatdd Daily Points Repx"
{
    // //
    DefaultLayout = RDLC;
    RDLCLayout = './ConsolidatddDailyPointsRepx.rdlc';
    ...
    dataset
    {
        ...
        {
            CalcFields = Points;
            DataItemTableView = SORTING ("Points Sort Bay", Status) ORDER(Descending) WHERE (Status = FILTER (Order), "No." = FILTER ('I' .. 'K'));
            ...
            begin
                ...
                until k = 9;
                if Countz <> 0 then SeaTempA := SeaTemp / Countz else SeaTempA := 0;
