report 99883 "Daily BreakUp by Vessel ExceZZ"
{
    // "Inventory Posting Group"."Inventory total1"
    DefaultLayout = RDLC;
    RDLCLayout = './DailyBreakUpbyVesselExceZZ.rdlc';
    ...
    dataset
    {
        dataitem("Inventory Posting Group"; "Inventory Posting Group")
        {
            ...
            column(Inventory_Posting_Group__Inventory_total1__Control1000000106; "Inventory total1")
            {
            }
            ...
            column(Inventory_Posting_Group__Inventory_total1__Control1000000106Caption; FieldCaption("Inventory total1"))
            {
            }
            ...
            column(Inventory_Posting_Group__Inventory_total1__Control1000000106Caption_Control1000000164; FieldCaption("Inventory total1"))
            {
            }
