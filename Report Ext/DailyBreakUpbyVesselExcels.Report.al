report 59983 "Daily BreakUp by Vessel Excels"
{
    DefaultLayout = RDLC;
    RDLCLayout = './DailyBreakUpbyVesselExcels.rdlc';
    ...
    dataset
    {
        dataitem("Inventory Posting G Cat Tot"; "Inventory Posting Group")
        {
            ...
            begin
                ...
                //AAA - Aug 2002 Generateyp Location SeaDays based on Current Voyage
                ...
                if locate2.Find('-') then
                    repeat
                        ...
                        //  Operatn.SETFILTER(Operatn."Task Filter",'SHR'); #1
                        Operatn.CalcFields(Operatn.Points);
                        locate2."Last Reportd Shrimps Pts" := Operatn.Points;
                        // Operatn.SETRANGE(Operatn."Task Filter");  #1
                        locate2.Modify();
        ...
        dataitem("Inventory Posting Group"; "Inventory Posting Group")
        {
            ...
            column(Inventory_Posting_Group__Inventory_total2_; "Inventory total2")
            {
            }
            ...
            column(Inventory_Posting_Group__Inventory_total2__Control30; "Inventory total2")
            {
            }
            ...
            column(Inventory_Posting_Group__Inventory_total2__Control33; "Inventory total2")
            {
            }
            ...
            column(Inventory_Posting_Group__Inventory_total2_Caption; FieldCaption("Inventory total2"))
            {
            }
            ...
            column(Inventory_Posting_Group__Inventory_total2_Caption_Control1000000160; FieldCaption("Inventory total2"))
            {
            }
            column(Inventory_Posting_Group_DescriptionCaption_Control1000000161; FieldCaption(Description))
            {
            }
            column(Inventory_Posting_Group__Inventory_total1_Caption_Control1000000164; FieldCaption("Inventory total1"))
            {
            }
