report 50997 "Voyage P&L Ledger LineU"
{
    DefaultLayout = RDLC;
    RDLCLayout = './VoyagePLLedgerLineU.rdlc';
    ...
    dataset
    {
        ...
        dataitem("Sea Food categories"; "Sea Food categories")
        {
            ...
            dataitem("Job Ledger Entry Rep"; "Job Ledger Entry")
            {
                ...
                begin
                    ...
                    Itempr.SETRANGE(Itempr."Item No.","No.");
                    Itempr.SETRANGE(Itempr."Starting Date",0D,"Posting Date");
                    IF Itempr.FIND('+') THEN Prc:=Itempr."Unit Price" ELSE Prc:=0; */ // &u
        ...
        dataitem("Value Entry"; "Value Entry")
        {
            ...
            trigger OnPreDataItem()
            begin
                //"Job Ledger Entry".COPYFILTER("Job Ledger Entry"."Job No.","Value Entry"."Document No."); } //AA
            end;
        }
