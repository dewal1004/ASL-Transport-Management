report 90088 "Consolidatdd Daily Points Repk"
{
    // CountCum[I]
    // DayofTide
    // //
    DefaultLayout = RDLC;
    RDLCLayout = './ConsolidatddDailyPointsRepk.rdlc';
    ...
    dataset
    {
        ...
        {
            CalcFields = Points;
            DataItemTableView = SORTING ("No.") WHERE (Status = CONST ("Voyage Start"));
            ...
            column(DOTCaption; DOTCaptionLbl)
            {
            }
            ...
            column(Temp__CCaption; Temp__CCaptionLbl)
            {
            }
            ...
            begin
                ...
                job1.Get(Job."No.");
                // job1.SETRANGE(job1."Task Filter"); & u
                ...
                if JobLdgr.Find('+') then begin
                    //  SeTemp:= JobLdgr."Step Code"; & u
                    //SeArea:=JobLdgr."Phase Code"; & u
                end
                else begin
                    SeTemp := '';
                    SeArea := '';
                ...
                // job1.SETFILTER(job1."Task Filter",'SHR'); & u
                job1.CalcFields(job1.Points);
                pts[5] := job1.Points;

                // job1.SETFILTER(job1."Task Filter",'FIS'); & u
                job1.CalcFields(job1.Points);
                pts[4] := job1.Points;
                ...
                // job1.SETRANGE(job1."Task Filter");  // & u
                // job1.SETRANGE(job1."Type Filter",0); // & u
    ...
    var
        ...
        DOTCaptionLbl: Label 'Day of Tide';
        ...
        Temp__CCaptionLbl: Label 'Temp. C';
