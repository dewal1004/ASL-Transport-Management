report 55151 "Voyage P&L Ledger Linexc"
{
    DefaultLayout = RDLC;
    RDLCLayout = './VoyagePLLedgerLinexc.rdlc';
    ...
    dataset
    {
        dataitem("Job Ledger Entry"; "Job Ledger Entry")
        {
            ...
            begin
                ...
                //SETRANGE(Itempr."Starting Date",0D,"Posting Date");#1
        ...
        dataitem("Integer"; "Integer")
        {
            ...
            begin
                ...
                if NairaVal <> 0 then GrossPerct := (GrossMarg) * 100 / NairaVal;
