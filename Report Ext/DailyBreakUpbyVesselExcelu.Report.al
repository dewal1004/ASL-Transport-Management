report 51083 "Daily BreakUp by Vessel Excelu"
{
    DefaultLayout = RDLC;
    RDLCLayout = './DailyBreakUpbyVesselExcelu.rdlc';

    dataset
    {
        dataitem("Inventory Posting Group"; "Inventory Posting Group")
        {
            column(Daily_Break_Up_by_Vessel_As_On____FORMAT_WorkDat_0_4_; 'Daily Break Up by Vessel As On: ' + Format(WorkDat, 0, 4))
            {
            }
            ...
            column(Daily_Break_Up_by_Vessel_As_On____FORMAT_WorkDat_0_4__Control1000000707; 'Daily Break Up by Vessel As On: ' + Format(WorkDat, 0, 4))
            {
            }
            column(USERID_Control1000000712; UserId)
            {
            }
            column(CurrReport_PAGENO_Control1000000714; CurrReport.PageNo)
            {
            }
            ...
            column(SeaRangeC_20__Control1000000822; SeaRangeC[20])
            {
                DecimalPlaces = 0 : 0;
            }
            column(SeaRangeC_19__Control1000000823; SeaRangeC[19])
            {
                DecimalPlaces = 0 : 0;
            }
            column(SeaRangeC_18__Control1000000824; SeaRangeC[18])
            {
                DecimalPlaces = 0 : 0;
            }
            column(SeaRangeC_17__Control1000000825; SeaRangeC[17])
            {
                DecimalPlaces = 0 : 0;
            }
            column(SeaRangeC_15__Control1000000827; SeaRangeC[15])
            {
                DecimalPlaces = 0 : 0;
            }
            column(SeaRangeC_14__Control1000000828; SeaRangeC[14])
            {
                DecimalPlaces = 0 : 0;
            }
            column(SeaRangeC_13__Control1000000829; SeaRangeC[13])
            {
                DecimalPlaces = 0 : 0;
            }
            column(SeaRangeC_12__Control1000000830; SeaRangeC[12])
            {
                DecimalPlaces = 0 : 0;
            }
            column(SeaRangeC_11__Control1000000831; SeaRangeC[11])
            {
                DecimalPlaces = 0 : 0;
            }
            column(SeaRangeC_10__Control1000000832; SeaRangeC[10])
            {
                DecimalPlaces = 0 : 0;
            }
            column(SeaRangeC_9__Control1000000833; SeaRangeC[9])
            {
                DecimalPlaces = 0 : 0;
            }
            column(SeaRangeC_8__Control1000000834; SeaRangeC[8])
            {
                DecimalPlaces = 0 : 0;
            }
            column(SeaRangeC_7__Control1000000835; SeaRangeC[7])
            {
                DecimalPlaces = 0 : 0;
            }
            column(SeaRangeC_6__Control1000000836; SeaRangeC[6])
            {
                DecimalPlaces = 0 : 0;
            }
            column(SeaRangeC_5__Control1000000837; SeaRangeC[5])
            {
                DecimalPlaces = 0 : 0;
            }
            column(SeaRangeC_4__Control1000000838; SeaRangeC[4])
            {
                DecimalPlaces = 0 : 0;
            }
            column(SeaRangeC_3__Control1000000839; SeaRangeC[3])
            {
                DecimalPlaces = 0 : 0;
            }
            column(SeaRangeC_2__Control1000000840; SeaRangeC[2])
            {
                DecimalPlaces = 0 : 0;
            }
            column(SeaRangeC_1__Control1000000816; SeaRangeC[1])
            {
                DecimalPlaces = 0 : 0;
            }
            ...
            column(SeaRangeC_26__Control1000000795; SeaRangeC[26])
            {
                DecimalPlaces = 0 : 0;
            }
            column(SeaRangeC_27__Control1000000796; SeaRangeC[27])
            {
                DecimalPlaces = 0 : 0;
            }
            column(SeaRangeC_28__Control1000000797; SeaRangeC[28])
            {
                DecimalPlaces = 0 : 0;
            }
            ...
            column(Inventory_Posting_Group_Inventory_Control26; Inventory)
            {
            }
            column(Inventory_Posting_Group_Description_Control14; Description)
            {
            }
            ...
            column(Inventory_Posting_Group_Inventory_Control26Caption; FieldCaption(Inventory))
            {
            }
            column(Inventory_Posting_Group_Description_Control14Caption; FieldCaption(Description))
            {
            }
            ...
            column(CurrReport_PAGENO_Control1000000714Caption; CurrReport_PAGENO_Control1000000714CaptionLbl)
            {
            }
            column(Inventory_Posting_Group_Inventory_Control26Caption_Control1000000160; FieldCaption(Inventory))
            {
            }
            column(Inventory_Posting_Group_Description_Control14Caption_Control1000000161; FieldCaption(Description))
            {
            }
    ...
    var
        ...
        CurrReport_PAGENO_Control1000000714CaptionLbl: Label 'Page';
