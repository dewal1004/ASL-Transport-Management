report 66661 "Payroll Report1"
{
    ...
    DefaultLayout = RDLC;
    RDLCLayout = './PayrollReport1.rdlc';
    ...
    dataset
    {
        dataitem("Payroll-Payslip Lines."; "Payroll-Payslip Lines.")
        {
            ...
            dataitem(Employee; Employee)
            {
                ...
                column(employee_name; Employee."First Name")
                {
                }
            ...
            begin
                ...
                CurrReport.ShowOutput((EDAmountsArray[1] > 0) or
                                      (EDAmountsArray[2] > 0) or
                                      (EDAmountsArray[3] > 0) or
                                      (EDAmountsArray[4] > 0) or
                                      (EDAmountsArray[5] > 0) or
                                      (EDAmountsArray[6] > 0) or
                                      (EDAmountsArray[7] > 0) or
                                      (EDAmountsArray[8] > 0) or
                                      (EDAmountsArray[9] > 0) or
                                      (EDAmountsArray[10] > 0) or
                                      (EDAmountsArray[11] > 0) or
                                      (EDAmountsArray[12] > 0));

                if ((EDAmountsArray[1] > 0) or (EDAmountsArray[2] > 0) or
                    (EDAmountsArray[3] > 0) or (EDAmountsArray[4] > 0) or
                    (EDAmountsArray[5] > 0) or (EDAmountsArray[6] > 0) or
                    (EDAmountsArray[7] > 0) or (EDAmountsArray[8] > 0) or
                    (EDAmountsArray[9] > 0) or (EDAmountsArray[10] > 0) or
                    (EDAmountsArray[11] > 0) or (EDAmountsArray[12] > 0)) then begin
