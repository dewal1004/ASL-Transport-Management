report 70090 "Mp Budget reportx"
{
    // "Employment Contract".Budget
    DefaultLayout = RDLC;
    RDLCLayout = './MpBudgetreportx.rdlc';
    ...
    dataset
    {
        dataitem("Employment Contract"; "Employment Contract")
        {
            ...
            column(Employment_Contract_Budget; Budget)
            {
            }
            ...
            column(Employment_Contract__Budgeted_Count_; "Budgeted Count")
            {
            }
            ...
            column(RequiredCaption; RequiredCaptionLbl)
            {
            }
            ...
            begin
                ...
                //CurrReport.CREATETOTALS("Budgeted Count",Permtt,Contatt,Tott,Contbtt,junitt,inttt,Sentt,Reqtt,Exptt);   #1
            end;
        }
    }
    ...
    trigger OnPreReport()
    begin
        //Emplcontractfilte:= "Employment Contract".GETFILTERS;  #1
    end;
    ...
    var
        ...
        RequiredCaptionLbl: Label 'Required';
