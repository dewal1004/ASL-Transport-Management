report 80151 "Voyage P&L Ledger LineZ"
{
    // "Job Ledger Entry"."Total Price"
    DefaultLayout = RDLC;
    RDLCLayout = './VoyagePLLedgerLineZ.rdlc';
    ...
    dataset
    {
        ...
        dataitem("Value Entry"; "Value Entry")
        {
            ...
            RequestFilterFields = "Document No.", "Gen. Prod. Posting Group";
            ...
            column(GPPGDesc_Control1000000089; GPPGDesc)
            {
            }
