report 99503 "Edit PDate>Trans Ord Dat Recei"
{
    DefaultLayout = RDLC;
    RDLCLayout = './EditPDateTransOrdDatRecei.rdlc';
    ...
    dataset
    {
        dataitem("Transfer Receipt Header"; "Transfer Receipt Header")
        {
            ...
            column(Transfer_Receipt_Header__Transfer_Value_; "Transfer Value")
            {
            }
            column(Transfer_Receipt_Header__Transfer_From_Voy__No__; "Transfer From Voy. No.")
            {
            }
            ...
            column(Transfer_Receipt_Header__Transfer_Value_Caption; FieldCaption("Transfer Value"))
            {
            }
            column(Transfer_Receipt_Header__Transfer_From_Voy__No__Caption; FieldCaption("Transfer From Voy. No."))
            {
            }
