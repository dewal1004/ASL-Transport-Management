report 90113 "Daily BreakUp by Vess Summaryc"
{
    ...
    DefaultLayout = RDLC;
    RDLCLayout = './DailyBreakUpbyVessSummaryc.rdlc';
    ...
    dataset
    {
        dataitem("Inventory Posting G Cat Tot"; "Inventory Posting Group")
        {
            ...
            column(USERID_________FORMAT_TODAY_0_4_; UserId + ' :  ' + Format(Today, 0, 4))
            {
            }
            ...
            begin
                ...
                if locate2.Find('-') then
                    repeat
                        ...
                        //Operatn.SETRANGE(Operatn."Task Filter");//#dik
                        locate2.Modify();
        ...
        dataitem("Inventory Posting Group 2"; "Inventory Posting Group")
        {
            ...
            column(Fish_PointsCaption_Control1000000212; Fish_PointsCaption_Control1000000212Lbl)
            {
            }
    ...
    var
        ...
        Fish_PointsCaption_Control1000000212Lbl: Label 'Fish Points';
