tableextension 50273 tableextension50273 extends "Purchase Header"
{
    fields
    {
        ...
        */
        ...
        field(50360; "Original Purc. Order No."; Code[20])
        {
            ...
            trigger OnValidate()
            begin
                if "Original Purc. Order No." <> '' then begin
